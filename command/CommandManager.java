...
public class CommandManager {
    ...
    public CommandManager(Main main) {
        ...
        expensesCommand = new ExpensesCommand(main);
        incomeCommand = new IncomeCommand(main);
    }
    ...
    public void readCommand() {
        ...
        if (command.equalsIgnoreCase("help")) {
            ...
            expensesCommand.visaUtgifter(manager.getTransaktioner());
            System.out.println("______________________________________________________________");
            System.out.println("Kör vidare! ('create'/'list'/'balance'/'delete'/'expenses'/'income'/'help'/'stop')");

        } else if (command.equalsIgnoreCase("income")) {
            incomeCommand.visaInkomster(manager.getTransaktioner());
            System.out.println("______________________________________________________________");
            System.out.println("Kör vidare! ('create'/'list'/'balance'/'delete'/'expenses'/'income'/'help'/'stop')");
